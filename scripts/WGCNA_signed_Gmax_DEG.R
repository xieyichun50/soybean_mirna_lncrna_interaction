...
####read in expression
exp.mRNA<-read.csv(file = "run/Gmax/Gmax_mRNA_filter_gene_count_matrix.csv", 
                   header = TRUE)
DEG<-read.table("run/Gmax/DEGlist.Gmax.txt", header = TRUE)
...
#88       969       835       123       194        66       121      5629       321 
#merge cut 0.2
#black      blue     brown     green      grey   magenta      pink    purple       red turquoise    yellow 
#121       854       702       210       194        88       115        66       123      5552       321
